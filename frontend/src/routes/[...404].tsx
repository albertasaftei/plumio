      ...
      <div class="flex flex-col items-center gap-6 max-w-sm w-full text-center">
        ...
        <div class="flex items-center gap-3 w-full">
          ...
          <button
            ...
            class="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-surface hover:bg-elevated text-secondary-body hover:text-body border border-base text-sm font-medium transition-colors duration-150"
          >
