  ...
  return (
    <div class="space-y-4">
      <div>
        ...
        <div class="flex rounded-md border border-[var(--color-border)] overflow-hidden text-sm">
          <button
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          <label class="text-sm text-[var(--color-text-secondary)]">Tags</label>
              ...
              {(tag) => {
                ...
                return (
                  <button
                    ...
                    class="w-full px-3 py-2 text-left text-sm rounded-lg hover:bg-[var(--color-bg-elevated)] transition-colors flex items-center gap-3 cursor-pointer"
                    classList={{
                      "bg-[var(--color-bg-elevated)]": isSelected(),
                    }}
                  >
                    <div
                      class={`w-5 h-5 flex-shrink-0 ${isSelected() ? "i-carbon-checkbox-checked text-[var(--color-primary)]" : "i-carbon-checkbox text-[var(--color-text-muted)]"}`}
                    />
                    <div
                      class="w-3.5 h-3.5 rounded-full flex-shrink-0 border border-[var(--color-border)]"
                      style={{
                        "background-color":
