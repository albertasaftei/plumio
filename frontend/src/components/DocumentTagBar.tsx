  ...
  return (
    <div class="px-4 py-1.5 border-b border-subtle bg-base flex items-center gap-1.5 min-h-8 flex-wrap">
      ...
      <Popover>
        ...
        />
        <Popover.Portal>
          <Popover.Content class="mt-1 bg-surface border border-base rounded-lg shadow-lg z-50 min-w-48 animate-slide-down">
            {/* Search input */}
            <div class="p-2 border-b border-base">
              <input
                ...
                class="w-full px-2 py-1 text-sm bg-base border border-base rounded text-body placeholder-muted-body focus:outline-none focus:border-[var(--color-primary)]"
              />
            </div>
